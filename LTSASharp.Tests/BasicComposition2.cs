...
namespace LTSASharp.Tests
{
    ...
    public class BasicComposition2  :BaseTest
    {
        ...
        {
            const string prog1 = "||S = a[1..3]:P.";
            const string prog2 = "||S = {a[1],a[2],a[3]}:P.";
            const string prog3 = "||S = forall[i:1..3] a[i]:P.";
            const string prog4 = "||S = forall[i:1..3] a:P/{a[i]/a}.";
            const string prog5 = "||S = (a[1]:P || a[2]:P || a[3]:P).";
